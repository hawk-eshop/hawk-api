...
export class Init1717753004936 implements MigrationInterface {
    name = 'Init1717753004936'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "hawk_roles" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "permissions" text, "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "creatorId" character varying, "modifyAt" TIMESTAMP NOT NULL DEFAULT now(), "modifier" character varying, "isDeleted" boolean NOT NULL DEFAULT false, "deletedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletorId" character varying, CONSTRAINT "UQ_c0d54fdb1e44967339001eb47bc" UNIQUE ("name"), CONSTRAINT "PK_5580e5226fdab6f69ed84e8a226" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "hawk_users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "securityStamp" character varying, "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "creatorId" character varying, "modifyAt" TIMESTAMP NOT NULL DEFAULT now(), "modifier" character varying, "isDeleted" boolean NOT NULL DEFAULT false, "deletedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletorId" character varying, CONSTRAINT "UQ_3a8e01f7c0e1d4520a1030afbcc" UNIQUE ("email"), CONSTRAINT "PK_8a4b49505eec82f0e3dacfe10f1" PRIMARY KEY ("id"))`);
