import { DatabaseMongoUUIDEntityAbstract } from '@shared/common/database/abstracts/mongo/entities/database.mongo.uuid.entity.abstract'
import {
  DatabaseEntity,
  DatabaseProp,
  DatabaseSchema
...
import { IDatabaseDocument } from '@shared/common/database/interfaces/database.interface'
