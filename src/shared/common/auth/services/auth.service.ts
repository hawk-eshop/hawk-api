...
import {
  ...
  HelperHashService,
  HelperStringService
} from '@shared/common/helpers/services'
import { IAuthService } from '@shared/common/auth/interfaces/auth.service.interface'
import { IAuthPassword } from '@shared/common/auth/interfaces/auth.interface'
import { ENUM_AUTH_LOGIN_FROM } from '@shared/common/auth/constants/auth.enum.constant'
import { AuthJwtAccessPayloadDto } from '@shared/common/auth/dtos/jwt/auth.jwt.access-payload.dto'
import { AuthJwtRefreshPayloadDto } from '@shared/common/auth/dtos/jwt/auth.jwt.refresh-payload.dto'
import { AuthSocialApplePayloadDto } from '@shared/common/auth/dtos/social/auth.social.apple-payload.dto'
import { AuthSocialGooglePayloadDto } from '@shared/common/auth/dtos/social/auth.social.google-payload.dto'
...
export class AuthService implements IAuthService {
  ...
  constructor(
    ...
    // apple
    this.appleClientId = this.configService.get<string>('auth.apple.clientId')
  ...
  async createRefreshToken(payload: AuthJwtRefreshPayloadDto): Promise<string> {
    return this.helperEncryptionService.jwtEncrypt(
      { ...payload },
      {
