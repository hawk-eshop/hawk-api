...
import { ENUM_DOC_REQUEST_BODY_TYPE } from '@shared/common/docs/constants/docs.enum.constant'
import {
  IDocAuthOptions,
  IDocDefaultOptions,
  IDocGuardOptions,
  ...
  IDocResponseOptions
} from '@shared/common/docs/interfaces/docs.interface'
import { ENUM_FILE_MIME } from '@shared/common/file/constants/file.enum.constant'
import { ENUM_PAGINATION_ORDER_DIRECTION_TYPE } from '@shared/common/pagination/constants/pagination.enum.constant'
import { ENUM_REQUEST_STATUS_CODE_ERROR } from '@shared/common/request/constants/request.status-code.constant'
...
export function DocAuth(options?: IDocAuthOptions) {
  ...
  if (options?.xApiKey) {
    ...
    oneOfUnauthorized.push(
      {
        statusCode: ENUM_API_KEY_STATUS_CODE_ERROR.X_API_KEY_REQUIRED_ERROR,
        messagePath: 'apiKey.error.xApiKey.required'
      },
      {
        statusCode: ENUM_API_KEY_STATUS_CODE_ERROR.X_API_KEY_NOT_FOUND_ERROR,
        messagePath: 'apiKey.error.xApiKey.notFound'
      },
      {
        statusCode: ENUM_API_KEY_STATUS_CODE_ERROR.X_API_KEY_EXPIRED_ERROR,
        messagePath: 'apiKey.error.xApiKey.expired'
      },
      {
        statusCode: ENUM_API_KEY_STATUS_CODE_ERROR.X_API_KEY_INVALID_ERROR,
        messagePath: 'apiKey.error.xApiKey.invalid'
      },
      {
        statusCode: ENUM_API_KEY_STATUS_CODE_ERROR.X_API_KEY_FORBIDDEN_ERROR,
