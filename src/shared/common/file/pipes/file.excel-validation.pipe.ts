...
import { IFileRows } from '@shared/common/file/interfaces/file.interface'
import { FileImportException } from '@shared/common/file/exceptions/file.import.exception'
  ...
  async validate(value: IFileRows<T>[]): Promise<void> {
    if (!value || value.length === 0) {
      throw new UnprocessableEntityException({
        statusCode: ENUM_FILE_STATUS_CODE_ERROR.REQUIRED_EXTRACT_FIRST_ERROR,
